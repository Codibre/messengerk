...
import com.github.Codibre.messengerk.exception.NoHandlerForMessageException
import com.github.Codibre.messengerk.handler.HandlerDescriptor
import com.github.Codibre.messengerk.handler.HandlerLocator
import com.github.Codibre.messengerk.stamp.HandledStamp
...
class HandleMessageMiddleware(
     ...
     * It invokes each handler in the order of their priority, as defined by the `com.github.Codibre.annotations.MessageHandler` annotation.
    ...
    override fun handle(envelope: Envelope<Any>, stack: MiddlewareStack): Envelope<Any> {
        ...
        val sortedHandlers = handlers.sortedBy { handlerDescriptor ->
            handlerDescriptor.kClass.annotations.filterIsInstance<MessageHandler>()
